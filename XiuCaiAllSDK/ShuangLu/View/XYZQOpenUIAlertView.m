...
//  XYZQOpenAccount
//
//  Created by xyzq on 17/7/17.
//  Copyright © 2017年 xyzq. All rights reserved.
//

#import "XYZQOpenUIAlertView.h"
@interface XYZQOpenUIAlertView () <UIAlertViewDelegate> @end
@implementation XYZQOpenUIAlertView
...
+(void)showAlertWithTitle:(NSString *)title
            ...
            buttonHandler:(OpenUIAlertViewButtonHandler)handler
{
    XYZQOpenUIAlertView* alert = [[self alloc] initWithTitle:title
                                             message:message
  ...
  timeoutMessageFormat:(NSString*)countDownMessageFormat
{
    ...
    OpenUIAlertViewButtonHandler finalHandler = [self.buttonHandler copy];
    self.buttonHandler = ^(XYZQOpenUIAlertView* bhAlert, NSInteger bhButtonIndex)
    {
