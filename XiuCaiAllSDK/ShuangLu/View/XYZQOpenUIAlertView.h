...
@interface XYZQOpenUIAlertView : UIAlertView
typedef void(^OpenUIAlertViewButtonHandler)(XYZQOpenUIAlertView* alert, NSInteger buttonIndex);
@property (nonatomic, copy) OpenUIAlertViewButtonHandler buttonHandler;
